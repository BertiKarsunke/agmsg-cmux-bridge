...
agmsg-cmux is a fork scaffold of fujibee/agmsg at `0653e5d`.

It keeps the original agmsg MIT attribution to fujibee and will borrow tmux/cmux pane integration patterns from cmux-bridge (MIT, paichi). The new fork direction is turn-mode pane-push delivery for both tmux and cmux sessions.
